...
const ChatBox = () => {
  ...
  return (
    <Flex justify="flex-end" pr="2rem">
      ...
      >
        <Flex
          className="text-xl text-white bg-purple-800 p-4 flex items-end justify-between gap-[2rem] rounded-t-[11px] cursor-pointer"
        ...
        {open ? (
          <Box className="p-5 h-[16rem] overflow-y-auto scrollbar-thin">
            {users?.map((user) => (
              <Box key={user.id}>
                <Flex gap="8" mb={8}>
                  <Image
